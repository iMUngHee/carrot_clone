      ...
      <div className="rounded-3xl bg-white p-6 shadow-xl">
        ...
        <ul>
          {[1, 2, 3, 4, 5].map((i) => (
            <div
              key={i}
              className="my-2 flex justify-between odd:bg-blue-100 even:bg-yellow-100"
            >
        ...
        <button
          className="
          mx-auto mt-5 block w-2/4 rounded-xl bg-blue-500 p-3 text-center text-white
      ...
      <div className="group overflow-hidden rounded-2xl bg-white shadow-xl">
        ...
        <div className="relative -top-5 rounded-3xl bg-white p-6">
          <div className="relative -top-16 flex items-end justify-between">
            ...
            <div className="h-24 w-24 rounded-full bg-red-400 transition-colors group-hover:bg-green-400" />
            <div className="flex flex-col items-center">
